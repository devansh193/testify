...
const ProductDetails: React.FC = React.memo(() => {
  ...
  const [description, setDescription] = useRecoilState(descriptionSelector);
  const [image, setImage] = useRecoilState(imageSelector);
  const [videoReview, setVideoReview] = useRecoilState(videoReviewSelector);
