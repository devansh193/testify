...
export default function TestimonialForm() {
  ...
  return (
    <div className="flex flex-col items-center justify-center max-w-5xl w-full px-6 bg-gradient-to-b from-background to-secondary/20">
      <UserNav />
      <motion.div
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              {boardDetails?.isVideoReview && (
                <div className="text-center">
                  ...
                  <div className="group cursor-pointer hover:scale-105 transition duration-200">
