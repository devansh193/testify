...
export default function ProductDashboard() {
  const [products, setProducts] = useState([
    ...
    },
    {
      ...
      description:
        "Enhance your writing with our AI-powered assistant. Perfect for content creators and marketers.",
      testimonials: 8,
      rating: 4.5,
      views: 800,
      conversions: 42,
    ...
    },
    {
      ...
      description:
        "Build stronger remote teams with our virtual team-building platform.",
      testimonials: 12,
      rating: 4.7,
      views: 950,
      conversions: 55,
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Create a new product to collect testimonials for.
                </DialogDescription>
              </DialogHeader>
